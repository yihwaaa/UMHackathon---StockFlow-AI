...
## Pitch Video
[Watch the pitch video here](https://drive.google.com/file/d/1RDH5-lF7VtVbW6ZItq5WN2f7dIaUTNbr/view?usp=sharing)
...
├─ start.py
├─ stockflow.db
├─ UMHackathon Product Requirement Documentation.pdf
├─ UMHackathon System Analysis Documentation.pdf
├─ UMHackathon2026 - pitch deck.pdf
└─ UMHackathon Quality Assurance Testing Documentation.pdf
```
...
3. Quality Assurance Testing Documentation (QATD)  
   `UMHackathon Quality Assurance Testing Documentation.pdf`
4. Pitch Deck (Presentation Slides)  
   `UMHackathon2026 - pitch deck.pdf`
